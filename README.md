...
<table>
    <tr>
        <td>
            <img draggable="false" src="./docs/extension.png" alt="Chrome의 확장" />
        </td>
        <td>
            <img draggable="false" src="./docs/discord.png" alt="Discord에 실제로 뜨는 RPC" />
        </td>
    </tr>
    <tr>
...
<img draggable="false" src="./docs/chrome.png" width="550">
